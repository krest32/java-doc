...
1. TypeScript 是 JS 的超集，能够完全的兼容 JS，并在 JS 的基础上进行功能扩展
1. Python 日常的生活问题、脚本类语言非常合适，因为类库多，也被用于机器学习与人工AI领域
2. Java性能不错，同时支持网络编程，所以主要适合Web后端开发
3. C、C++ 操作系统资源调用 ，用作核心系统组件，操作系统资源
4. R 数据分析、科学计算
5. Go 类似于 C C++，但是比C、C++ 更加简单，目前Go 主要有两种方向：
   1. 中间件开发：K8S istio
   2. 核心高并发业务 
...
6. 面向对象开发的基本原则是什么？（六大原則）
7. 为什么要有基本数据的包装类？
8. Integer 缓存池有了解过么？
9. new Integer 和 Integer.valueOf 之间的区别是什么？
10. 为什么要使用缓存池？缓存池在什么位置？采用了使用了什么设计模式？
11. String 为什么会比 StringBuilder 慢？
12. switch 能否用在String上？那么Long呢？为什么不支持Long？
13. 对于 static 关键字的理解？
14. 对于 final 关键字的理解？
15. 什么是内部类？为什么要有内部类？
16. 接口和抽象类的区别？
17. `==` 和 equal 之间的区别？
18. 对象比较时，为什么要重写 Equal()  方法后，一定要重写 hashcode() 方法？
19. Java 使用的值传递还是引用传递？二者有什么区别
20. 什么是 IO ？
21. BIO、 NIO、AIO 是什么？有什么区别？
21. 字符流与字节流有什么区别，用到了什么设计模式？
    1. 字符流拥有缓存区
    2. 字符流方便我们操作数据 
23. 多路复用 IO 模型的概念，有什么优缺点？
24. 对于反射的理解，应用场景有哪些？
25. 如何提高反射的效率 ？
26. 序列化有什么用？serivalVersionUUID 作用？ transient 的作用？
27. 分布式系统如何进行序列化操作？
28. 为什么要使用日志框架？
29. 最近关于 `log4j2` 的bug有了解过么？漏洞补救措施，漏洞解决措施？
30. 什么是Java 异常？
31. Java 异常的分类有哪些？
32. 常见的异常有哪些？
33. 你们系统中异常是如何处理的？
34. try... catch.... finally 中  finally  使用 return 为什么是禁止的 ？
35. 什么是泛型？
35. 为什么要使用泛型？ 
