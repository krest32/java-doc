...
[xxl-job源码解析(看这一篇就够了，超简约且详细)](https://blog.csdn.net/Nuan_Feng/article/details/115619448?ops_request_misc=%257B%2522request%255Fid%2522%253A%2522166183197316782246431555%2522%252C%2522scm%2522%253A%252220140713.130102334..%2522%257D&request_id=166183197316782246431555&biz_id=0&utm_medium=distribute.pc_search_result.none-task-blog-2~all~sobaiduend~default-1-115619448-null-null.142^v42^pc_rank_34,185^v2^control&utm_term=xxljob%E6%BA%90%E7%A0%81&spm=1018.2226.3001.4187)



## 服务端启动

![image-20220830122335037](img/image-20220830122335037.png)
...
1. 初始化触发器线程池,
2. **注意：这里分别初始化了2个线程池，一个快一个慢，优先选择快，当一分钟以内任务超过10次执行时间超过500ms，则加入慢线程池执行。**
...
![img](img/watermark,type_ZHJvaWRzYW5zZmFsbGJhY2s,shadow_50,text_Q1NETiBATnVhbl9GZW5n,size_20,color_FFFFFF,t_70,g_se,x_16.png)
...
![img](img/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L051YW5fRmVuZw==,size_16,color_FFFFFF,t_70.png)
