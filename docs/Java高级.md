...
11. 谈谈你对并发编程的理解？
    ...
    1. 什么是并发编程/多线程？
    2. 并发编程的三要素？
    3. 如何处理并发造成的一些问题？原子性、可见性、有序性？
    4. 对线程安全的理解？（针对一段代码来说，它是否是安全的）
    5. 线程安全的处理方式通常有哪些？
    6. 线程安全方式之间的对比？synchronized 与 lock
    7. Synchronized锁升级的过程？
    8. ReentrantLock 的理解？
      1. 概念、特性、实现原理（如何实现  可重入锁?）

    9. 创建线程的方式有哪些？
    10. 线程池相关
      1. 线程池的七大参数？
      2. 线程池线程复用的原理：实现了线程和任务之间的分离，当然任务需要执行值，之间交给线程，执行run方法即可
      3. 线程池的工作原理？

    11. 并发容器有哪些？
    12. 并发工具类 countDownLatch 和 Semphere
       1. countDownLatch ：底层实现，使用 await 会阻塞，等待所有事项一起完成再
       2. Semphere：相当于是一个许可，有几个停车位
...
23. 谈谈你对于Spring Boot的理解？

    + 什么是Spring Boot？
    + Spring Boot自动装配的原理是怎么样的？
    + 如何自定义Starter？

24. 谈谈你对于Spring Cloud的理解？
