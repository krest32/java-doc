...
提供链路追踪：通过Sleuth可以很清楚的看到一次请求经过哪些服务调用，可以方便理清服务间调用关系。性能分析、数据分析、优化链路：通过Sleuth可以很方便的看出每个采样请求的耗时，分析出哪些服务调用比较耗时，可以为微服务系统的调优提供数据支撑。
...
[示例代码](https://github.com/seata/seata-samples.git)
...
![image-20230922162848261](img/image-20230922162848261.png)
