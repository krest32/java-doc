...
互联网野蛮生长的时代已经过去，国际形式日益复杂也为经济发展带来了挑战。目前中国的核心目标从低端的制造业中脱离出来，进行产业升级。我从事后端开发工作，未来几年信息产业方面如何发展也会与我自身息息相关的：
...
1. 人工智能：
   ...
   2. 行业AI发力，比如
      1. 自动驾驶
      2. 全屋智能
2. 大数据挖掘分析：政企数据、商业数据、消费者数据
3. 政企数字化建设，这类需要一直都会有
   1. 为各个行业进行赋能，比如：智慧校园、智慧水电等
   2. 部分技术型企业，自研产品或系统

总结：个人会更加看好大数据、人工智能，它也是国家战略性的产业。跟着国家的方向走，总归是不会出错的，属于目前的蓝海行业，但是入行门槛比较高。

再说前后端技术，互联网发展这么多年，it技术发展已经相对来说比较成熟，你在工作中遇到的问题，其中99%都会有现成解决方案，只不过it其实早已经不再是蓝海了，经济如果持续下行，我感觉未来几年，这个行业的竞争仍然会持续增加，所以目前能做的就是不断加强自身的技术积累。
...
8. 为什么要固守使用`JDK 8`？对比 `JDK 11`和`JDK 17`?
